...
**Some Optional Features Require advanced-custom-fields plugin***
...
[vm_document_embed width=\"\" height=\"\" src=\"\"]
* You can add this functionality to your theme using [code]do_shortcode("[vm_document_embed width=\"\" height=\"\" src=\"\"]")[/code]
...
* To add to an individual post: Add [vm_document_embed} shortcode to your post using the following syntax:
[vm_document_embed width=\"\" height=\"\" src=\"\"]
* You can add this functionality to your theme using [code]do_shortcode("[vm_document_embed width=\"\" height=\"\"]")[/code]
...
6. Add the vm_document_embed shortcode to your post/page or to
